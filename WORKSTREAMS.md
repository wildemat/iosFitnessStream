...
4. `feature/start-stream` — WorkoutSessionManager (HKWorkoutSession + HKAnchoredObjectQuery), StreamClient (POST JSON), LocationManager (CoreLocation), WorkoutMetrics (Codable), LiveMetricsViewController (minimal), ViewController navigation wiring
